...
import (
	...
	"github.com/groundcover-com/groundcover-sdk-go/pkg/client/profiling"
	...
	"github.com/groundcover-com/groundcover-sdk-go/pkg/client/storage_management"
...
func New(transport runtime.ClientTransport, formats strfmt.Registry) *GroundcoverAPI {
	...
	cli.Profiling = profiling.New(transport, formats)
	...
	cli.StorageManagement = storage_management.New(transport, formats)
...
type GroundcoverAPI struct {
	...
	Profiling profiling.ClientService
	...
	StorageManagement storage_management.ClientService
...
func (c *GroundcoverAPI) SetTransport(transport runtime.ClientTransport) {
	...
	c.Profiling.SetTransport(transport)
	...
	c.StorageManagement.SetTransport(transport)
