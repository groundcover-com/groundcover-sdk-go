...
type CreateMonitorInternalServerError struct {
	Payload *CreateMonitorInternalServerErrorBody
}
...
func (o *CreateMonitorInternalServerError) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /api/monitors][%d] createMonitorInternalServerError %s", 500, payload)
}
...
func (o *CreateMonitorInternalServerError) GetPayload() *CreateMonitorInternalServerErrorBody {
	return o.Payload
}
...
func (o *CreateMonitorInternalServerError) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
	...
	o.Payload = new(CreateMonitorInternalServerErrorBody)
...
/*
CreateMonitorInternalServerErrorBody create monitor internal server error body
swagger:model CreateMonitorInternalServerErrorBody
*/
type CreateMonitorInternalServerErrorBody struct {

	// message
	Message string `json:"message,omitempty"`
}

// Validate validates this create monitor internal server error body
func (o *CreateMonitorInternalServerErrorBody) Validate(formats strfmt.Registry) error {
	return nil
}

// ContextValidate validates this create monitor internal server error body based on context it is used
func (o *CreateMonitorInternalServerErrorBody) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	return nil
}

// MarshalBinary interface implementation
func (o *CreateMonitorInternalServerErrorBody) MarshalBinary() ([]byte, error) {
	if o == nil {
		return nil, nil
	}
	return swag.WriteJSON(o)
...
// UnmarshalBinary interface implementation
func (o *CreateMonitorInternalServerErrorBody) UnmarshalBinary(b []byte) error {
	var res CreateMonitorInternalServerErrorBody
	if err := swag.ReadJSON(b, &res); err != nil {
		return err
	}
	*o = res
