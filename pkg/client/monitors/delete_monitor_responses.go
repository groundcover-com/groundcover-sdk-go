...
func (o *DeleteMonitorReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 202:
		result := NewDeleteMonitorAccepted()
...
// NewDeleteMonitorAccepted creates a DeleteMonitorAccepted with default headers values
func NewDeleteMonitorAccepted() *DeleteMonitorAccepted {
	return &DeleteMonitorAccepted{}
}
...
// IsSuccess returns true when this delete monitor accepted response has a 2xx status code
func (o *DeleteMonitorAccepted) IsSuccess() bool {
	return true
}

// IsRedirect returns true when this delete monitor accepted response has a 3xx status code
func (o *DeleteMonitorAccepted) IsRedirect() bool {
	return false
}

// IsClientError returns true when this delete monitor accepted response has a 4xx status code
func (o *DeleteMonitorAccepted) IsClientError() bool {
	return false
}

// IsServerError returns true when this delete monitor accepted response has a 5xx status code
func (o *DeleteMonitorAccepted) IsServerError() bool {
	return false
}

// IsCode returns true when this delete monitor accepted response a status code equal to that given
func (o *DeleteMonitorAccepted) IsCode(code int) bool {
	return code == 202
}

// Code gets the status code for the delete monitor accepted response
func (o *DeleteMonitorAccepted) Code() int {
	return 202
}

func (o *DeleteMonitorAccepted) Error() string {
	return fmt.Sprintf("[DELETE /api/monitors/{id}][%d] deleteMonitorAccepted", 202)
}

func (o *DeleteMonitorAccepted) String() string {
	return fmt.Sprintf("[DELETE /api/monitors/{id}][%d] deleteMonitorAccepted", 202)
}

func (o *DeleteMonitorAccepted) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
