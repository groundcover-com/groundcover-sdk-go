...
type ClientService interface {
	...
	DeleteMonitor(params *DeleteMonitorParams, opts ...ClientOption) (*DeleteMonitorAccepted, error)

	GetMonitor(params *GetMonitorParams, opts ...ClientOption) (*GetMonitorOK, error)

	ListMonitors(params *ListMonitorsParams, opts ...ClientOption) (*ListMonitorsOK, error)

	UpdateMonitor(params *UpdateMonitorParams, opts ...ClientOption) (*UpdateMonitorAccepted, error)
...
*/
func (a *Client) DeleteMonitor(params *DeleteMonitorParams, opts ...ClientOption) (*DeleteMonitorAccepted, error) {
	// TODO: Validate the params before sending
	if params == nil {
	...
	success, ok := result.(*DeleteMonitorAccepted)
	if ok {
		return success, nil
	}
	// unexpected success response
...
*/
func (a *Client) GetMonitor(params *GetMonitorParams, opts ...ClientOption) (*GetMonitorOK, error) {
	// TODO: Validate the params before sending
	if params == nil {
...
*/
func (a *Client) UpdateMonitor(params *UpdateMonitorParams, opts ...ClientOption) (*UpdateMonitorAccepted, error) {
	// TODO: Validate the params before sending
	if params == nil {
