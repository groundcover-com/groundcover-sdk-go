...
// WithIncludeRecurring adds the includeRecurring to the get all silences params
func (o *GetAllSilencesParams) WithIncludeRecurring(includeRecurring *bool) *GetAllSilencesParams {
	o.SetIncludeRecurring(includeRecurring)
	return o
}

// SetIncludeRecurring adds the includeRecurring to the get all silences params
func (o *GetAllSilencesParams) SetIncludeRecurring(includeRecurring *bool) {
...
func (o *GetAllSilencesParams) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {
	...
	if o.IncludeRecurring != nil {

		// query param includeRecurring
		var qrIncludeRecurring bool

		if o.IncludeRecurring != nil {
			qrIncludeRecurring = *o.IncludeRecurring
		}
