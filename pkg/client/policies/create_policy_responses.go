...
func (o *CreatePolicyReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 500:
		...
		return nil, result
	default:
		return nil, runtime.NewAPIError("[POST /api/rbac/policies] createPolicy", response, response.Code())
	}
}
...
CreatePolicyCreated create policy created
*/
...
func (o *CreatePolicyCreated) Error() string {
	...
	return fmt.Sprintf("[POST /api/rbac/policies][%d] createPolicyCreated %s", 201, payload)
}
...
func (o *CreatePolicyBadRequest) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /api/rbac/policies][%d] createPolicyBadRequest %s", 400, payload)
}
...
func (o *CreatePolicyInternalServerError) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /api/rbac/policies][%d] createPolicyInternalServerError %s", 500, payload)
}
...
func (o *CreatePolicyCreatedBody) Validate(formats strfmt.Registry) error {
	...
	if err := o.validatePolicyID(formats); err != nil {
		res = append(res, err)
	}
...
func (o *CreatePolicyCreatedBody) validatePolicyID(formats strfmt.Registry) error {

	if err := validate.Required("createPolicyCreated"+"."+"policyId", "body", o.PolicyID); err != nil {
		return err
	}
...
// ContextValidate validates this create policy created body based on context it is used
func (o *CreatePolicyCreatedBody) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	return nil
}
