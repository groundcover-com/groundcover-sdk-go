...
type ClientService interface {
	ApplyPolicy(params *ApplyPolicyParams, opts ...ClientOption) (*ApplyPolicyOK, error)

	CreatePolicy(params *CreatePolicyParams, opts ...ClientOption) (*CreatePolicyCreated, error)
	...
	GetPolicyAuditTrail(params *GetPolicyAuditTrailParams, opts ...ClientOption) (*GetPolicyAuditTrailOK, error)

	ListPolicies(params *ListPoliciesParams, opts ...ClientOption) (*ListPoliciesOK, error)

	UpdatePolicy(params *UpdatePolicyParams, opts ...ClientOption) (*UpdatePolicyAccepted, error)
...
*/
func (a *Client) ApplyPolicy(params *ApplyPolicyParams, opts ...ClientOption) (*ApplyPolicyOK, error) {
...
*/
func (a *Client) CreatePolicy(params *CreatePolicyParams, opts ...ClientOption) (*CreatePolicyCreated, error) {
	// TODO: Validate the params before sending
	if params == nil {
...
func (a *Client) DeletePolicy(params *DeletePolicyParams, opts ...ClientOption) (*DeletePolicyNoContent, error) {
	...
	op := &runtime.ClientOperation{
		ID:                 "deletePolicy",
		Method:             "DELETE",
		PathPattern:        "/api/rbac/policies/{id}",
		ProducesMediaTypes: []string{"application/json"},
		ConsumesMediaTypes: []string{"application/json"},
		Schemes:            []string{"http", "https"},
		Params:             params,
...
*/
func (a *Client) GetPolicyAuditTrail(params *GetPolicyAuditTrailParams, opts ...ClientOption) (*GetPolicyAuditTrailOK, error) {
	// TODO: Validate the params before sending
	if params == nil {
	...
	op := &runtime.ClientOperation{
		...
		Method:             "GET",
		PathPattern:        "/policies/{id}/auditTrail",
		ProducesMediaTypes: []string{"application/json"},
		ConsumesMediaTypes: []string{"application/json"},
		Schemes:            []string{"http", "https"},
		Params:             params,
...
*/
func (a *Client) UpdatePolicy(params *UpdatePolicyParams, opts ...ClientOption) (*UpdatePolicyAccepted, error) {
	// TODO: Validate the params before sending
	if params == nil {
