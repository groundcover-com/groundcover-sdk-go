...
func (o *GetPolicyReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 500:
		...
		return nil, result
	default:
		return nil, runtime.NewAPIError("[GET /api/rbac/policies/{id}] getPolicy", response, response.Code())
	}
}
...
func (o *GetPolicyOK) Error() string {
	...
	return fmt.Sprintf("[GET /api/rbac/policies/{id}][%d] getPolicyOK %s", 200, payload)
}
...
func (o *GetPolicyBadRequest) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /api/rbac/policies/{id}][%d] getPolicyBadRequest %s", 400, payload)
}
...
func (o *GetPolicyNotFound) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /api/rbac/policies/{id}][%d] getPolicyNotFound %s", 404, payload)
}
...
func (o *GetPolicyInternalServerError) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /api/rbac/policies/{id}][%d] getPolicyInternalServerError %s", 500, payload)
}
