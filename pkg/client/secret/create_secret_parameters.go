...
type CreateSecretParams struct {
	...
	*/
	Body *models.CreateSecretRequest
...
func (o *CreateSecretParams) WithBody(body *models.CreateSecretRequest) *CreateSecretParams {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the create secret params
func (o *CreateSecretParams) SetBody(body *models.CreateSecretRequest) {
	o.Body = body
}
