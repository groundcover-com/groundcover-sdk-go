...
func (o *UpdateSecretParams) WithBody(body *models.UpdateSecretRequest) *UpdateSecretParams {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the update secret params
func (o *UpdateSecretParams) SetBody(body *models.UpdateSecretRequest) {
	o.Body = body
}
