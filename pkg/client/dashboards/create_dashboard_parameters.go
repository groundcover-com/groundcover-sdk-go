...
type CreateDashboardParams struct {
	...
	*/
	Body *models.CreateDashboardRequest
...
func (o *CreateDashboardParams) WithBody(body *models.CreateDashboardRequest) *CreateDashboardParams {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the create dashboard params
func (o *CreateDashboardParams) SetBody(body *models.CreateDashboardRequest) {
	o.Body = body
}
