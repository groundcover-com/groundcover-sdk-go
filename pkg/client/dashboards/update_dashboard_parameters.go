...
type UpdateDashboardParams struct {
	...
	*/
	Body *models.UpdateDashboardRequest
...
func (o *UpdateDashboardParams) WithBody(body *models.UpdateDashboardRequest) *UpdateDashboardParams {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the update dashboard params
func (o *UpdateDashboardParams) SetBody(body *models.UpdateDashboardRequest) {
	o.Body = body
}
