...
type ClientService interface {
	MetricsQuery(params *MetricsQueryParams, opts ...ClientOption) (*MetricsQueryOK, error)
...
*/
func (a *Client) MetricsQuery(params *MetricsQueryParams, opts ...ClientOption) (*MetricsQueryOK, error) {
