...
type CreateServiceAccountOK struct {
	Payload *models.CreateServiceAccountResponse
}
...
func (o *CreateServiceAccountOK) GetPayload() *models.CreateServiceAccountResponse {
	return o.Payload
}
...
func (o *CreateServiceAccountOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
	...
	o.Payload = new(models.CreateServiceAccountResponse)
