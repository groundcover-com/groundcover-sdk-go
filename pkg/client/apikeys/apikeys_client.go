...
type ClientService interface {
	...
	DeleteAPIKey(params *DeleteAPIKeyParams, opts ...ClientOption) (*DeleteAPIKeyAccepted, error)
...
*/
func (a *Client) DeleteAPIKey(params *DeleteAPIKeyParams, opts ...ClientOption) (*DeleteAPIKeyAccepted, error) {
	// TODO: Validate the params before sending
	if params == nil {
