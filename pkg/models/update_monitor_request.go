...
func (m *UpdateMonitorRequest) validateNotificationSettings(formats strfmt.Registry) error {
...
func (m *UpdateMonitorRequest) contextValidateNotificationSettings(ctx context.Context, formats strfmt.Registry) error {
